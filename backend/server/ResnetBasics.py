...
class ResNetBasicBlockEncoder(nn.Module):
    def __init__(self, in_channels, out_channels, activation='leaky_relu', expansion=1, downsampling=1, *args,
                 **kwargs):
        super().__init__()
...
class ResNetBasicBlockDecoder(nn.Module):
    def __init__(self, in_channels, out_channels, activation='leaky_relu', expansion=1, upsampling=1, output_padding=0,
        ...
        self.blocks = nn.Sequential(
            ...
            nn.ConvTranspose1d(self.out_channels, self.expanded_channels, kernel_size=3,
